...
class DefaultNameDataValues : NameDataValues {
    ...
    override fun getFirstNames(): Array<String> {
        ...
        if (lang.equals("ENG"))
            toReturn = engFirstNames
        else if(lang.equals("HUN"))
            toReturn =  hunFirstNames
        return toReturn
    }
    ...
    override fun getLastNames(): Array<String> {
        var toReturn = arrayOf("")
        if (lang.equals("ENG"))
            toReturn = engLastNames
        else if(lang.equals("HUN"))
            toReturn =  hunLastNames
        return toReturn
    }
    ...
    override fun getPrefixes(): Array<String> {
        var toReturn = arrayOf("")
        if (lang.equals("ENG"))
            toReturn = engPrefixes
        else if(lang.equals("HUN"))
            toReturn =  hunPrefixes
        return toReturn
    }
    ...
    override fun getSuffixes(): Array<String>? {
        var toReturn = arrayOf("")
        if (lang.equals("ENG"))
            toReturn = engSuffixes
        return toReturn
    }

    private val engSuffixes = arrayOf("II", "III", "Phd", "Jr", "Sr")
    private val engPrefixes = arrayOf("Mr", "Mrs", "Ms")
    private val hunPrefixes = arrayOf("Id.", "Özv.", "Dr.", "Ifj.")

    private val hunFirstNames = arrayOf("András", "Róbert", "Klára", "Virág",
    "Péter", "Sarolta", "Tivadar", "Mátyás", "Imre", "István", "Dezső", "Tünde",
    "Nóra", "Krisztina", "Krisztián", "Tamás", "Gyöngyi", "Angéla", "Sándor", "Márta",
    "Martin", "József", "Mariann", "Szabolcs", "Szabina", "Máté", "Ádám", "Éva",
    "Béla", "Bettina", "Cintia", "Miklós", "Dániel", "Daniella", "Márk", "Norbert",
    "Botond", "Kamilla", "Alex", "Szilvia", "Gábor", "Gabriella", "László", "Károly",
    "Győző", "Elemér", "Rózsa", "Cecília")

    private val hunLastNames = arrayOf("Kovács", "Szabó", "Kiss", "Nagy", "Horváth",
    "Németh", "Fekete", "Kormos", "Makai", "Szegedi", "Szász", "Tóth", "Varga", "Balogh",
    "Papp", "Lakatos", "Farkas", "Oláh", "Szilágyi", "Török", "Mészáros", "Juhász",
    "Takács", "Molnár", "Szűcs", "Orsós", "Kocsis", "Fodor", "Szalai", "Sipos", "Magyar",
    "Gál", "Balázs", "Fehér", "Simon")

    private val engFirstNames = arrayOf("Aaron", "Abby", "Abigail", "Adam",
    ...
    private val engLastNames = arrayOf("Abbott", "Acevedo", "Acosta",
