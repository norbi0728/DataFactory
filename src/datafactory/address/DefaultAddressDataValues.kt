...
class DefaultAddressDataValues : AddressDataValues {
    ...
    override fun getStreetNames(): Array<String> {
        var toReturn = arrayOf("")
        if (lang.equals("ENG")){
            toReturn = engStreetNames
        }else if (lang.equals("HUN")){
            toReturn = hunStreetNames
        }
        return toReturn
    }
    ...
    override fun getAddressSuffixes(): Array<String> {
        var toReturn = arrayOf("")
        if (lang.equals("ENG")){
            toReturn = engAddressSuffixes
        }else if (lang.equals("HUN")){
            toReturn = hunAdressSuffixes
        }
        return toReturn
    }
    private val hunStreetNames = arrayOf("Hársfa", "Diófa", "Kossuth", "Kölcsey",
    "Stadion", "Táncsics Mihály", "Róbert Károly", "Egyetem", "Erzsébet", "Ady Endre",
    "Akácfa", "Ács", "Erdő", "Bagolyvári", "Bajcsy-Zsilinszky", "Árpád", "Damjanich",
    "Tábori", "Dugovics Titusz", "Deák Ferenc", "Fenyves", "Gelencsér", "Ibolya")

    private val hunAdressSuffixes = arrayOf("utca", "köz", "tér", "liget", "út",
    "sor", "dűlő", "park", "sétány")

    private val hunCities = arrayOf("Veszprém", "Budapest", "Gyöngyös", "Szeged", "Pétfürdő",
    "Gyulafirátót", "Kecskemét", "Mosónmagyaróvár", "Győr", "Zalaegerszeg", "Szombathely",
    "Vecsés", "Gyula", "Nyíregyháza", "Sopron", "Hajdúszoboszló", "Gárdony", "Székesfehérvár",
    "Tiszavasvári", "Sárszentmihály")

    private val engStreetNames = arrayOf("Aberdeen", "Abington", "Academy",
    ...
    private val engAddressSuffixes = arrayOf("Avenue", "Boulevard",
        ...
        "Blvd", "Ave", "Drv")
    private val engCities = arrayOf("Abba", "Abbeville", "Acworth",
